...
class MovietvRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteDataSource: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MovietvRepository =
            instance ?: synchronized(this) {
                instance ?: MovietvRepository(remoteDataSource, localData, appExecutors).apply { instance = this }
            }
    }
